...
namespace DataFunc.Integrations.ExactOnline.SalesEntryLines.Models
{
    [ExactOnlineResource("/api/v1/{0}/salesentry/SalesEntryLines")]
    public class SalesEntryDetailLineModel
    {
